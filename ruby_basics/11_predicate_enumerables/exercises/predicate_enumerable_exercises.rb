def coffee_drink?(drink_list)
 ...
 if  (drink_list.include?("coffee") == false)
  return drink_list.include?("espresso")
 else return true
 end
...
def twenty_first_century_years?(year_list)
  ...
  year_list.all? {|years| years.between?(2001,2100)}
end
...
def valid_scores?(score_list, perfect_score)
  ...
  score_list.one?{|score_list, score| score == perfect_score}
end
